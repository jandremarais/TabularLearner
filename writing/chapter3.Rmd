...
In CLR, the learning rate is varied cyclically between two boundary values.
Hence a CLR cycle consists of two stages.
In the first stage the learning rate linearly increases to a certain maximum, and in the second stage the learning rate linearly decreases to a chosen minimum.
...
In Smith (2015), a simple method for finding reasonable learning rate boundaries.
...
See \autoref{fig:range_test} for example output of the range test and how to deterimine the learning rate bounds for the 1Cycle policy.
