...
For most of the experiments we will do a 5-fold cross validation [@] to estimate the performance of a model. 
...
Cross-validation is rarely done in Deep Learning, since the models typically take very long to train and any repitition is thus further costly.
