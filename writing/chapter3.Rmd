...
The semi-supervised (or 'unsupervised) learning exploited for example in autoencoders played a key part in the rise of deep learning (debatedly starting with [@Hinton2006]).
