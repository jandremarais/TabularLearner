...
The term refers to the process of temporarily removing a set of neurons and their connections during NN training.
...
consists of randomly setting the output of a hidden neuron to zero with probability $p$.
