...
The authors then cite @McCleland1986, @Hinton1989, and Utgoff and Stracuzzi @Utgoff2002.
...
Perhaps the most important autoencoder contributions thus far are so-called *denoising autoencoders* [@Vincent2008], *stacked denoising autoencoders* [@Vincent2010], *contractive autoencoders* [@Rifai2011], *semi-supervised recursive autoencoders* [@Socher2011], and *variational autoencoders* [@Kingma2013]. 
...
A useful autoencoder is an NN that succeeds in finding latent representations of the data that are of a smaller dimension than that of the input domain, thereby learning useful data features.
...
In order to encourage such representation learning by means of an autoencoder, they are typically constructed with some type of constraint imposed.
...
An alternative way of imposing constraints in autoencoders, is to add toise to the inputs before passing it to the encoder.
...
The interested reader is referred to the paper by @Alain2014, where it is shown that DAEs are able to learn useful data structures.
