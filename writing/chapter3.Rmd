...
From this perspective, deep (multilayer) neural networks were already proposed by Alexey Ivakhnenko more than half a century ago [@Alexey1965].
In the paper by Vincent *et al.* (2008) it is stated that "the belief that additional levels of functional decomposition will yield increased representational and modeling power is not new". 
The authors then cite McCleland 
