...
A further modern architecture which speeds up training of deep neural networks considerably, is the use of so-called *skip connections*.
The invention of skip connections is attributed to 
