...
Therefore we provide all the code, data and necessary documentation to reproduce the experiments that were done in this thesis[^git2]. 
...
[^git2]: All of these are shared publicly at https://github.com/jandremarais/tabularLearner
...
Regularisation learning paper [@Shavitt2018] only tested their approach on one dataset.
