...
As mentioned in \Sref{sec:datasets}, in our empirical analyses we aim to avoid feature engineering and preprocessing.
...
We observe that in terms of validation loss, the model with eight layers using SeLU activations performed the best overall; whereas in terms of accuracy, the model with two layers using ReLU activations emerged as the winner.
