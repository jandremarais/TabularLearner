...
Therefore we provide all the code, data and necessary documentation to reproduce the experiments that were done in this thesis (see \autoref{app:C}). 
...
+ **Strong baselines**: In order to know how well we are doing we need to able to compare our performance with those of others.

For more specifics on the dataset, one can refer to \autoref{app:A}
