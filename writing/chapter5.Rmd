...
The main objective of this chapter is to better understand the behaviours of certain neural network model architectures and their parameters.
...
Our aim is not necessarily to beat the benchmark, but instead consists of simple experiments designed to aid in understanding techniques.
...
Recall the learning problem associated with the Adult dataset, *viz*. 
