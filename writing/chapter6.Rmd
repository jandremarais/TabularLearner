...
With a view to future research directions, in this section we would like to point the reader to the potential of using *generative models* in the context of deep learning for tabular data.
...
We propose studying VAEs as a means to perform more effective unsupervised pretraining, 
