...
In \textbf{\Cref{chp:intro}} the motivation and the objectives of the study were described.
...
The focus in \textbf{\Cref{chp:nn}} were the core concepts in neural networks, and neural network training.
...
The topic in \textbf{\Cref{chp:dl}} was deep learning. 
...
\textbf{\Cref{chp:td}} was devoted to the topic of deep learning for tabular data.
