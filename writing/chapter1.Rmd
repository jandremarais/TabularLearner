...
This thesis is about using Deep Learning (DL) approaches to solve machine learning tasks where tabular data are the inputs.
...
Deep learning resulted in tremendous improvements in many machine learning applications, especially in the domains of image, text and audio processing. 
The datasets in these domains are what some call unstructured data. 
Why is it called unstructured? 
In a sense the data is homogeneous. 
Cite reviews of deep learning in these domains. 
Show the growth of deep learning papers, conference applications and deep learning software. 
But where we haven’t seen much exploration of deep learning is applying it to structure data also referred to as tabular data. 
...
- summary of dl
- summary of advances in dl in other fields
