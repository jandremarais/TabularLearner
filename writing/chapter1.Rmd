...
- review current state of field and promsing future directions.

This thesis acts as a tutoriol for applying Deep Learning to tabular data.
We review the recent literature on DL and specifically, applying DL to tabular data.
and also includes a literature review and empirical study on what works where.
