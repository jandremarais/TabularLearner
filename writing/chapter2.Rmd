...
Furthermore, the maximum gradient of the sigmoid activation function is turns out to be only 0.25 (at $x=0.5$). The nature of the chain rule therefore causes lower layers in the network to train much slower than higher layers.
...
The local derivatives of the activation functions discussed in this section are plotted in \autoref{fig:activation_functions} (b). The form of these functions will become more apparent in \Cref{sec:training}.
