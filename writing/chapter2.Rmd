...
```{r, fig.cap="Activations.\\label{fig:activation_functions}", fig.subcap=c('Function','Local Derivative'), out.width='50%', fig.show='hold'}
...
The *recurrent neural network* (RNN) [@Mikolov2010] is a class of neural networks that are helpful for modelling variable lenght inputs or outputs, for example in machine translation or video classification.
