...
The algorithm updates exponential moving averages of the gradient, $m_{t}$, and the squared gradient, $v_{t}$, where the exponential decay rates of these moving averages are controlled by the hyperparamters $\beta_{1},\beta_{2}\in [0,1)$.
