...
An artifical NN tries to copy this stucture by modelling what happens inside of a single neuron by a weighted combination of its inputs, combined with a simple non-linear transformation.
