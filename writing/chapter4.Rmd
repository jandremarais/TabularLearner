...
In Chapters 2 and 3 we have covered the basics of neural networks, as well as the more recent advances in deep learning.
The aim of this chapter is to explore ways in which the modern deep learning approaches in Chapter 3 may be leveraged in the application of deep learning for tabular data.
In Chapter 1 alluded to the differences of tabular data when compared to unstructured data like such as images, and data used in text and speech applications.
The widely acclaimed successes of deep learning typically occur areas such as image classification, machine translation and speech recognition.
In the literature only a handful of publications reporting successful implementation of deep learning for tabular data may be found.
important applications such as recommender systems [@haldar2018], click-through rate prediction[^ctr] [@Song2018], analysis of electronic health records [@Rajkomar2018] and transport related problems [@Brebisson2015], to name a few.
