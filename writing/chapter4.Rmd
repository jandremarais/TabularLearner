...
Broadly speaking, there are structural hyperparamters to select, like the number of layers and the type of activation function, but then there are also learning algorithm hyperparameter, like the learning rate or the weight decay.
...
In most of the literature we have investigated the researcher perform a grid search over many combinations of of hyperparamters [@Song2018], [@Wang2017b], [@Zhang2016], [@Qu2016], [@Guo2017], [@Covington2016].
...
Therefore we will test its effectiveness here.
First we compare the constant learning rate schedule with the 1Cycle policy.
Then we show how to find the optimal weight decay.
