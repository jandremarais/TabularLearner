...
plt.savefig('../writing/figures/cont_vars.png', bbox_inches='tight')

sns.jointplot(gaus_norm(x1), gaus_norm(x2), alpha=0.3)
plt.savefig('../writing/figures/gaus_norm.png', bbox_inches='tight')

sns.jointplot(power_norm(x1), power_norm(x2), alpha=0.3)
plt.savefig('../writing/figures/power_norm.png', bbox_inches='tight')